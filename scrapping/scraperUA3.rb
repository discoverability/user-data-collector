...
browser.text_field(id: "add-profile-name").set "#{$profile3_username}"
...
browser.span(text: "#{$profile3_username}").click
...
File.write("results_#{time}_#{$profile3_username}_snap1.csv", thumbs_final)

#content1
browser.goto("https://www.netflix.com/watch/#{$profile3_content1}")
puts "\n#{browser.url}"
Watir::Wait.until(timeout: 10800) { browser.div(class: "PromotedVideo").present? || browser.span(class: "ltr-18i00qw").present? }

# #content2
browser.goto("https://www.netflix.com/watch/#{$profile3_content2}")
Watir::Wait.until(timeout: 10800) { browser.div(class: "PromotedVideo").present? || browser.span(class: "ltr-18i00qw").present? }
...
scheduler.at "#{$day2}" do
    ...
    # #content3
    browser.goto("https://www.netflix.com/watch/#{$profile3_content3}")
    Watir::Wait.until(timeout: 10800) { browser.div(class: "PromotedVideo").present? || browser.span(class: "ltr-18i00qw").present? }

    # #content4
    browser.goto("https://www.netflix.com/watch/#{$profile3_content4}")
    Watir::Wait.until(timeout: 10800) { browser.div(class: "PromotedVideo").present? || browser.span(class: "ltr-18i00qw").present? }
    ...
    File.write("results_#{time}_#{$profile3_username}_snap2.csv", thumbs_final)
end
